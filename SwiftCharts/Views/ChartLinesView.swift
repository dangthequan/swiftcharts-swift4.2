...
open class ChartLinesView: UIView {
    ...
    open func generateLayer(path: UIBezierPath) -> CAShapeLayer {
        ...
        lineLayer.lineJoin = convertToCAShapeLayerLineJoin(lineJoin.CALayerString) as String
        lineLayer.lineCap = convertToCAShapeLayerLineCap(lineCap.CALayerString) as String
...
fileprivate func convertToCAShapeLayerLineJoin(_ input: String) -> CAShapeLayerLineJoin {
	return CAShapeLayerLineJoin(string: input)
}

// Helper function inserted by Swift 4.2 migrator.
fileprivate func convertToCAShapeLayerLineCap(_ input: String) -> CAShapeLayerLineCap {
	return CAShapeLayerLineCap(string: input)
}
