...
public enum LineJoin {
    ...
    public var CALayerString: String {
        switch self {
        case .miter: return convertFromCAShapeLayerLineJoin(kCALineJoinMiter as CAShapeLayerLineJoin)
        case .round: return convertFromCAShapeLayerLineCap(kCALineCapRound as CAShapeLayerLineCap)
        case .bevel: return convertFromCAShapeLayerLineJoin(kCALineJoinBevel as CAShapeLayerLineJoin)
        }
    }
...
public enum LineCap {
    ...
    public var CALayerString: String {
        switch self {
        case .butt: return convertFromCAShapeLayerLineCap(kCALineCapButt as CAShapeLayerLineCap)
        case .round: return convertFromCAShapeLayerLineCap(kCALineCapRound as CAShapeLayerLineCap)
        case .square: return convertFromCAShapeLayerLineCap(kCALineCapSquare as CAShapeLayerLineCap)
        }
    }
